...
export class createInitialSchema1618586913672 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "cheatsheet_category" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "index" integer NOT NULL, CONSTRAINT "PK_741c7fed00cfbebb1da05f10d58" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "keybind" ("id" SERIAL NOT NULL, "cheatsheetId" integer NOT NULL, "categoryId" integer NOT NULL, "name" character varying NOT NULL, "keyCombination" character varying NOT NULL, "description" character varying NOT NULL, "likes" integer NOT NULL, "cheatsheetCategoryId" integer, CONSTRAINT "PK_9a17e61e064839687b8abb38a69" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "cheatsheet" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "logoUrl" character varying NOT NULL, CONSTRAINT "PK_21111d62d038f0986adb2d693ab" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
