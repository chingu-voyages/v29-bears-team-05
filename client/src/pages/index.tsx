  ...
  return (
    <div>
      <div className="grid grid-cols-1 py-20 px-3 bg-gray-700 flex justify-items-center text-center">
        ...
        <h4 className="text-white text-lg font-bold">Join other developers and level up your typing game</h4>
      </div>
      <div className="bg-gray-700 md:h-24 md:transform md:skew-y-3 md:transform md:-translate-y-12"></div>
    </div>
  );
}
